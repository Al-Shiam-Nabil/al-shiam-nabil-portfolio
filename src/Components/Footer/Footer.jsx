import { FaLinkedin, FaArrowUp, FaFacebookSquare } from "react-icons/fa";
        ...
        <div className=" grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-10 md:gap-20  ">
          ...
          <div className="flex flex-col ">
            ...
            <ul className="space-y-2">
              <li>
                <Link to="home" duration={700} smooth={true} className="hover:underline text-sm transition cursor-pointer">
                  Home
                </Link>
              </li>
              <li>
                <Link to="about" duration={700} smooth={true} className="hover:underline text-sm transition cursor-pointer">
                  About
                </Link>
              </li>
              <li>
                <Link to="techStack" duration={700} smooth={true} className="hover:underline text-sm transition cursor-pointer">
                  Tech Stack
                </Link>
              </li>

                <li>
                <Link to="projects" duration={700} smooth={true} className="hover:underline text-sm transition cursor-pointer">
                 Projects
                </Link>
              </li>
              ...
              <li>
                <Link
                  to="contact" duration={700} smooth={true}
                  className="hover:underline text-sm transition cursor-pointer"
                >
                  Contact
                </Link>
              </li>
